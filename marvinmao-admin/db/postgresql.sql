...
INSERT INTO sys_user (user_id, username, password, salt, email, mobile, status, dept_id, create_time) VALUES ('1', 'admin', 'e1153123d7d180ceeb820d577ff119876678732a68eef4e6ffc0b1f06a01f91b', 'YzcmCZNvbXocrsz9dm8e', 'root@marvinmao.io', '13612345678', '1', '1', '2016-11-11 11:11:11');
...
INSERT INTO sys_dept (dept_id, parent_id, name, order_num, del_flag) VALUES ('1', '0', '通用开源集团', '0', '0');
...
INSERT INTO schedule_job (bean_name, params, cron_expression, status, remark, create_time) VALUES ('testTask',  'marvinmao', '0 0/30 * * * ?', '0', '参数测试', '2016-12-01 23:16:46');
