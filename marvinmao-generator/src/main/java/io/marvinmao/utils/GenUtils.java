...
package io.marvinmao.utils;

import io.marvinmao.entity.ColumnEntity;
import io.marvinmao.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.marvinmao" : mainPath;
